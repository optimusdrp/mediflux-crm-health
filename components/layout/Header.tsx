...
export function Header({ onOpenDuplicatesModal, duplicatesCount = 0, onNavigateToLandingPage }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200 px-4 lg:px-6 py-3 flex items-center justify-between shadow-xs">
      ...
      <div className="flex items-center gap-2.5 sm:gap-4">
        ...
        <div className="hidden lg:flex items-center gap-2 px-3 py-1 bg-slate-50 border border-slate-200 rounded-lg text-xs">
